...
const CreateEventPopup = ({ handleClose, getAllEvents }) => {
  ...
  //     await axios
  //       .post("https://api.cloudinary.com/v1_1/ketantb/image/upload", imgData)
  //       .then((res) => {
    ...
    <div className="create-event-pop-up-container">
      ...
      <div>
        <TextField
          ...
          type="text"
          name="eventName"
          onChange={handleCreateEventForm}
        />
      ...
      <div className="create-event-pop-up-save-btn-container">
        ...
        {/* <button onClick={coverPageUpload}>save</button> */}
        <button onClick={postCreateEventForm}>save</button>
      </div>
    </div>
  );
};
